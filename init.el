...
(custom-set-variables
 ...
 '(fancy-splash-image "/home/prasen/.config/neofetch/rayquaza.png")
 '(package-selected-packages
   '(python-black dap-python dap-gdb-lldb py-autopep8 py-yapf yapfify flycheck-pyflakes lsp-python-ms flymake-python-pyflakes company-c-headers company-elisp spaceline powerline-evil powerline vertico-directory flycheck-inline flycheck-posframe doom-modeline lsp-java lsp-ui company-irony flycheck vertico evil-collection evil)))
(custom-set-faces
